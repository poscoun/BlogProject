    ...
    <div class="container-fluid">
          ...
          <div class="login-wrapper my-auto">
            ...
            <form action="#!" method="POST"  class="loginForm" id="login_form" >
              <div class="form-group">
                ...
                <input type="id" name="user_id" id="user_id" class="form-control" placeholder="ID">
              </div>
              <div class="form-group mb-4">
                <label for="password">Password</label>
                <input type="password" name="user_pw" id="user_pw" class="form-control" placeholder="Passsword">
              </div>
      ...
      $("#login").click(function(){
  		...
  		$("#login_form").submit();
            ...
            <a href="/user/modify" class="forgot-password-link">Forgot password?</a>
