	      ...
	      <div class="container">
	        <div class="row d-flex mb-5 contact-info">
	          <div class="col-md-12 mb-4">
	            <h2 class="h3 font-weight-bold">Profile Modify</h2>
	          </div>
	          <div class="w-100"></div>
	        </div>
	        ...
	        <div class="row block-9">
	          <div class="col-md-8 d-flex">
	            ...
	            <div class="form-group">
	            	<label>content</label>
	                <textarea name="" id="" cols="30" rows="7" class="form-control" placeholder="자기소개 글을 입력하세요"></textarea>
	              </div>
	              <div class="form-group">
	              	<label>Hobby</label>
	                <input type="text" class="form-control" placeholder="취미를 입력하세요">
	              </div>
	              <div class="form-group">
	              ...
	              <div class="form-group">
	                ...
	                <input type="text" class="form-control" placeholder="SNS 주소를 입력하세요">
	              </div>
